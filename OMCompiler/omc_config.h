...
/* jdpipe: removing szip, seems not to be needed on current MSYS2 */
/* FIXME these LDFLAGS should be formed using output from the local system's pkg-config outputs... */
# define DEFAULT_LDFLAGS "-fopenmp -Wl,-Bstatic -lregex -ltre -lintl -liconv -lexpat -lomcgc -lpthread -loleaut32 -limagehlp -lhdf5 -lz -Wl,-Bdynamic"
